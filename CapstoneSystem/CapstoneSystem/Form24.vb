    ...
    Private Sub LoadGradesBelow75()
        Try
            ...
            Using conn As New MySqlConnection(connectionString)
                ...
                Dim query As String = "SELECT s.RFID, g.NAME, 'Physical Education 3' AS subject, st.teacher " & _
                       "FROM grades g " & _
                       "INNER JOIN subjectsteacher st ON st.subject = 'Physical Education 3' " & _
                       "INNER JOIN student s ON s.NAME = g.NAME " & _
                       "WHERE g.`Physical Education 3` < 75 AND st.teacher = 'Ms. Casipit';"
