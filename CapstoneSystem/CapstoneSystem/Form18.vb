...
Public Class Form18
    ...
    Private Sub btnsubmit_Click(sender As Object, e As EventArgs)
        ...
        Try
            ...
            Using conn As New MySqlConnection(connectionString)
                conn.Open()
                Dim query As String = "INSERT INTO intervention (subject, teacher, studentname, Cause, Solution) VALUES (@subject, @teacher, @student, @cause, @solution)"
                Using cmd As New MySqlCommand(query, conn)
